...
export const metadata: Metadata = {
    ...
    description: "Can keratoconus cause blindness? Is it hereditary? Can you drive? Get definitive answers from a specialist with 2,000+ cases. Evidence-based, not generic advice.",
...
export default async function KeratoconusFAQPage() {
    ...
    const schema = {
        ...
        "description": "Comprehensive answers to the most common keratoconus questions, reviewed by a specialist with 2,000+ cases treated.",
