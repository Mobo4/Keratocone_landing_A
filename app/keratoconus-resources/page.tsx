...
export const metadata: Metadata = {
    title: 'Keratoconus Guides & Resources | 2,000+ Cases Treated',
    description: 'Learn stages, treatments & how to avoid surgery from a specialist with 2,000+ keratoconus cases. Free guides. Book consult: (714) 558-0641',
    alternates: {
