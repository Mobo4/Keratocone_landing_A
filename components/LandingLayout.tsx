            ...
            <div className="bg-eyecare-blue text-white text-xs md:text-sm py-1.5 md:py-2 border-b border-eyecare-dark-blue">
                <div className="container mx-auto px-4 flex justify-between md:justify-end items-center gap-3 md:gap-4">
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        ...
                        <a href="#" className="flex items-center hover:text-eyecare-lighter-blue transition-colors">
                            <User className="h-3 w-3 mr-1.5" />
                            <span className="font-medium">Patient Login</span>
                        </a>
                        <div className="h-4 w-px bg-white/20 hidden lg:block" />
                        <a href="#" className="hidden lg:flex items-center hover:text-eyecare-lighter-blue transition-colors">
                    ...
                    {/* Mobile: Simple CTA link instead of dropdown */}
                    <Link
                        href="#lead-form"
                        className="md:hidden text-xs font-semibold bg-white/20 px-3 py-1 rounded-full hover:bg-white/30 transition-colors"
                    >
                        Get Help →
                    </Link>
                </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-1.5 md:space-y-2 text-xs md:text-sm">
                                <li className="flex items-start gap-1.5">
                                    ...
                                    <span className="text-gray-300 text-xs">801 N Tustin Ave #404<br />Santa Ana, CA 92705</span>
                                </li>
