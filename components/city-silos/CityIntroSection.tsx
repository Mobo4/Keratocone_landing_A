    ...
    return (
        <section className="relative bg-eyecare-navy text-white py-20 lg:py-28 overflow-hidden">
            ...
            <div
                ...
                role="img"
                aria-label={`Corneal topography map representing keratoconus diagnosis for ${cityName} patients`}
            >
            ...
            <div className="container mx-auto px-4 relative z-20">
                <FadeIn>
                    <span className="inline-block py-1 px-3 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-300 text-sm font-medium mb-6 tracking-wide backdrop-blur-sm">
                        Keratoconus Specialist Serving {cityName}, {county === 'Orange County' ? 'CA' : county}
                    </span>

                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-6 max-w-4xl">
                        Keratoconus Doctor in{' '}
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Link
                            ...
                            aria-label={`Book keratoconus consultation for ${cityName} patients`}
                        >
                            Book {cityName} Keratoconus Consultation
                        </Link>
                        <Link
                            ...
                            aria-label="Call keratoconus specialist Dr. Bonakdar"
                        >
                            Call Keratoconus Specialist: (714) 558-0641
                        </Link>
                    </div>
                </FadeIn>
            </div>
