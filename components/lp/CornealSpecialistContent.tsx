...
const CONDITIONS = [
    {
        name: "Keratoconus",
        description: "Progressive corneal thinning and steepening that distorts vision. Our cornea specialist has treated 2,000+ keratoconus cases with scleral lenses.",
    },
    {
