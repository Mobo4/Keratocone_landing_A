...
export const soCalCities: CityData[] = [
    ...
    { slug: 'irvine', name: 'Irvine', county: 'Orange County', coordinates: { lat: 33.6846, lng: -117.8265 }, neighborhoods: ['Woodbridge', 'Northwood', 'University Park', 'Turtle Rock', 'Westpark', 'Orchard Hills', 'Portola Springs', 'Quail Hill', 'Shady Canyon'] },
    { slug: 'newport-beach', name: 'Newport Beach', county: 'Orange County', coordinates: { lat: 33.6189, lng: -117.9289 }, neighborhoods: ['Corona del Mar', 'Balboa Island', 'Lido Isle', 'Newport Coast', 'Fashion Island', 'Balboa Peninsula'] },
    { slug: 'santa-ana', name: 'Santa Ana', county: 'Orange County', coordinates: { lat: 33.7455, lng: -117.8677 }, neighborhoods: ['Downtown', 'Floral Park', 'French Park', 'South Coast', 'Metro Classic', 'Morning Sunwood', 'Santa Anita', 'Riverview West'] },
    { slug: 'anaheim', name: 'Anaheim', county: 'Orange County', coordinates: { lat: 33.8366, lng: -117.9143 }, neighborhoods: ['Anaheim Hills', 'Downtown Anaheim', 'Platinum Triangle', 'Anaheim Resort', 'West Anaheim'] },
    { slug: 'costa-mesa', name: 'Costa Mesa', county: 'Orange County', coordinates: { lat: 33.6411, lng: -117.9187 }, neighborhoods: ['Eastside', 'Westside', 'South Coast Metro', 'Mesa Verde', 'College Park'] },
    ...
    { slug: 'tustin', name: 'Tustin', county: 'Orange County', coordinates: { lat: 33.7458, lng: -117.8262 }, neighborhoods: ['Old Town', 'Tustin Ranch', 'Tustin Legacy', 'Tustin Meadows', 'Laurelwood', 'Red Hill'] },
    { slug: 'orange', name: 'Orange', county: 'Orange County', coordinates: { lat: 33.7879, lng: -117.8531 }, neighborhoods: ['Old Towne', 'Orange Park Acres', 'East Orange', 'Orange Hills', 'El Modena', 'Olive'] },
