    ...
    'north-county-sd': [
      {
        ...
        answer: `San Diego has excellent ophthalmologists, but very few clinicians who specialize specifically in scleral lens fitting for keratoconus. Scleral lens fitting is a niche skill that requires dedicated corneal topography equipment, a large diagnostic lens inventory, and high case volume to develop the pattern recognition that separates good fits from exceptional ones. Dr. Bonakdar's 2,000+ keratoconus cases and 35+ years of focused experience represent a level of specialization that most multi-specialty practices cannot match. ${cityName} patients who have tried scleral lenses from less experienced fitters often come to us for refitting—and the vision improvement is dramatic.`,
      },
      {
    ...
    'la-gateway': [
      {
        ...
        answer: `Los Angeles has world-class eye surgeons, but keratoconus scleral lens fitting is a different discipline than surgery. It requires iterative precision fitting, advanced corneal topography interpretation, and the patience to refine a lens design through multiple trials until the optics are truly optimized. Most large LA ophthalmology practices prioritize surgical volume—cataract, LASIK, retina—and fit scleral lenses only occasionally. Dr. Bonakdar's practice is built around specialty contact lens fitting for corneal disease. With 2,000+ keratoconus cases, this focused experience means faster, better fitting results. Our central Orange County location is often a shorter drive from ${cityName} than crossing LA to reach a Westside or Downtown specialist.`,
      },
      {
