...
export const cityTypeMetadata: Record<CityType, CityTypeMetadata> = {
  ...
  'la-gateway': {
    ...
    keratoconusRelevance:
      'LA patients have many ophthalmology options but few true scleral lens specialists. Differentiation through 2,000+ keratoconus cases and 35+ years experience. Freeway proximity makes Santa Ana accessible.',
  },
};
