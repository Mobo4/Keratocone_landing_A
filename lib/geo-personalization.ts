...
export function getPersonalization(
  ...
  if (keyword) {
    ...
    if (kw.includes('scleral'))
      return {
        ...
        subhead: '2,000+ fittings — restore clear, comfortable vision.',
    ...
    if (kw.includes('second opinion') || kw.includes('alternative'))
      return {
        ...
        subhead: 'Not satisfied with your current care? 2,000+ cases, Bascom Palmer trained.',
  ...
  if (utmCampaign) {
    ...
    if (camp.includes('kc_maxclicks') || camp.includes('keratoconus'))
      return {
        ...
        subhead: '2,000+ cases treated. Same-week appointments. Direct specialist access.',
  ...
  if (utmSource === 'facebook')
    return {
      ...
      subhead: '2,000+ cases treated by a Bascom Palmer trained specialist. Insurance accepted.',
  ...
  if (ocMatch) {
    return {
      ...
      socialProof: `2,000+ keratoconus patients from ${ocMatch} and Orange County`,
    };
  }
  ...
  if (ieMatch) {
    return {
      ...
      subhead: '2,000+ cases treated — specialized expertise near you.',
  ...
  if (sdMatch) {
    return {
      ...
      subhead: 'When your vision matters — 2,000+ cases, Bascom Palmer trained.',
...
function getDefault(): GeoPersonalization {
  return {
    ...
    subhead: 'Most clinics see 10 keratoconus patients a year. We\u2019ve treated 2,000+. Same-week appointments near you.',
