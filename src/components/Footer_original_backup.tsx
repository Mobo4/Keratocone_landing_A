      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/services" className="text-gray-300 hover:text-eyecare-light-purple transition-colors">Keratoconus Management</Link></li>
              <li><Link to="/conditions/dry-eye" className="text-gray-300 hover:text-eyecare-light-purple transition-colors">Dry Eye Treatment</Link></li>
              <li><Link to="/services" className="text-gray-300 hover:text-eyecare-light-purple transition-colors">Comprehensive Eye Exams</Link></li>
              ...
              <li><Link to="/conditions/headache-eye-fatigue" className="text-gray-300 hover:text-eyecare-light-purple transition-colors">Neurolens for Eye Strain</Link></li>
