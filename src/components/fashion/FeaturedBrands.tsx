    ...
    <section id="featured-brands" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Featured <span className="text-eyecare-blue">Designer</span> Brands</h2>
          <p className="text-gray-700 max-w-3xl mx-auto">
            We carry an extensive collection of premium designer eyewear from the world's most prestigious brands.
          </p>
        </div>
