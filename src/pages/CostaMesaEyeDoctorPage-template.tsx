...
const IrvineEyeDoctorPage = () => {
  const structuredData = {
    ...
    "name": "Dr. Alexander Bonakdar - Irvine Eye Doctor",
    "description": "Comprehensive eye care and keratoconus specialist serving Irvine families. Same-week appointments available.",
    "address": {
      "@type": "PostalAddress",
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO 
        title="Eye Doctor Irvine CA | Dr. Bonakdar Orange County Eye Care"
        description="Top-rated eye doctor in Irvine, CA. Dr. Bonakdar provides comprehensive eye exams, keratoconus treatment, contact lenses. Same-week appointments. (949) 658-2372"
        keywords="eye doctor Irvine, Irvine optometrist, eye exam Irvine, Irvine eye care"
      ...
      <main className="flex-1">
        ...
        <Hero 
          title="Irvine's Trusted Eye Doctor - Dr. Alexander Bonakdar"
          subtitle="Comprehensive Eye Care & Keratoconus Specialist Serving Irvine Families"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-2xl font-semibold mb-4 text-gray-900">Proudly Serving Irvine Since 1990</h3>
                  <ul className="space-y-2 text-gray-600">
                    <li>• Convenient for UCI students and staff</li>
                    <li>• Easy access from 405 and 5 freeways</li>
                    <li>• Close to Irvine Spectrum and John Wayne Airport</li>
                    <li>• Serving Woodbridge, Turtle Rock, University Park, Quail Hill</li>
                  </ul>
                </div>
