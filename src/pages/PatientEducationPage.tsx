...
const PatientEducationPage = () => {
  ...
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": "Eye Care Education Center",
    "description": "Comprehensive patient education resources for eye conditions, treatments, and eye health information.",
    "publisher": {
      "@type": "Organization",
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO 
        title="Eye Care Education Center | Comprehensive Eye Health Information"
        description="Learn about eye conditions, treatments, and eye health. Expert educational resources from Dr. Bonakdar's Eye Care Center in Orange County."
        keywords="eye education, eye conditions, eye health, patient education, eye care information, Orange County"
        ...
        <section className="bg-gradient-to-r from-blue-50 via-purple-50 to-cyan-50 py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="text-eyecare-blue">Eye Care</span> Education Center
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Expert information about eye conditions, treatments, and eye health. 
              Learn from Orange County's trusted eye care professionals.
            </p>
          ...
          <section className="py-12 bg-gray-50">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                  Explore eye conditions organized by the area of the eye they affect.
                </p>
              </div>
                      ...
                      <div className="space-y-2">
                        {category.conditions.slice(0, 3).map((condition) => (
                          <div key={condition.id} className="flex items-center justify-between">
                            <Link 
                              to={`/education/conditions/${condition.slug}`}
                        ...
                        {category.conditions.length > 3 && (
                          <Link 
                            to={`/education/categories/${category.slug}`}
...
const ConditionCard: React.FC<{ condition: Condition; featured?: boolean }> = ({ condition, featured = false }) => {
  ...
  return (
    <Link to={`/education/conditions/${condition.slug}`}>
