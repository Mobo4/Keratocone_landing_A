...
const DryEyeDoctorNearMeAnaheimResortPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Anaheim Resort"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Anaheim Resort!",
    "author": "Robert K.",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Anaheim Resort.",
    "author": "David W.",
    "location": "Anaheim Resort",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Anaheim Resort, Anaheim Resort dry-eye-doctor-near-me, Dry Eye Doctor Near Me Anaheim Resort, Anaheim Resort eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Anaheim Resort, Anaheim. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 20-25 minutes from Anaheim Resort. (949) 658-2372";
...
export default DryEyeDoctorNearMeAnaheimResortPage;