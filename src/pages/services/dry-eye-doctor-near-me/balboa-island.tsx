...
const DryEyeDoctorNearMeBalboaIslandPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Balboa Island"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Balboa Island!",
    "author": "Robert K.",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Balboa Island.",
    "author": "David W.",
    "location": "Balboa Island",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Balboa Island, Balboa Island dry-eye-doctor-near-me, Dry Eye Doctor Near Me Balboa Island, Balboa Island eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Balboa Island, Newport Beach. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 20-25 minutes from Balboa Island. (949) 658-2372";
...
export default DryEyeDoctorNearMeBalboaIslandPage;