...
const DryEyeDoctorNearMeCoronadelMarPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Corona del Mar"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Corona del Mar!",
    "author": "Robert K.",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Corona del Mar.",
    "author": "David W.",
    "location": "Corona del Mar",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Corona del Mar, Corona del Mar dry-eye-doctor-near-me, Dry Eye Doctor Near Me Corona del Mar, Corona del Mar eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Corona del Mar, Newport Beach. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 20-25 minutes from Corona del Mar. (949) 658-2372";
...
export default DryEyeDoctorNearMeCoronadelMarPage;