...
const DryEyeDoctorNearMeDowntownFullertonPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Downtown Fullerton"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Downtown Fullerton!",
    "author": "Robert K.",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Downtown Fullerton.",
    "author": "David W.",
    "location": "Downtown Fullerton",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Downtown Fullerton, Downtown Fullerton dry-eye-doctor-near-me, Dry Eye Doctor Near Me Downtown Fullerton, Downtown Fullerton eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Downtown Fullerton, Fullerton. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 20-25 minutes from Downtown Fullerton. (949) 658-2372";
...
export default DryEyeDoctorNearMeDowntownFullertonPage;