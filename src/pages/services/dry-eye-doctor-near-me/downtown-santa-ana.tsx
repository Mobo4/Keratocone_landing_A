...
const DryEyeDoctorNearMeDowntownSantaAnaPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Downtown Santa Ana"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Downtown Santa Ana!",
    "author": "Robert K.",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Downtown Santa Ana.",
    "author": "David W.",
    "location": "Downtown Santa Ana",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Downtown Santa Ana, Downtown Santa Ana dry-eye-doctor-near-me, Dry Eye Doctor Near Me Downtown Santa Ana, Downtown Santa Ana eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Downtown Santa Ana, Santa Ana. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 5-8 minutes from Downtown Santa Ana. (949) 658-2372";
...
export default DryEyeDoctorNearMeDowntownSantaAnaPage;