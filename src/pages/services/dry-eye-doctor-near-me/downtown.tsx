...
const DryEyeDoctorNearMeDowntownPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Downtown"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Downtown!",
    "author": "Robert K.",
    "location": "Downtown",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Downtown.",
    "author": "David W.",
    "location": "Downtown",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Downtown, Downtown dry-eye-doctor-near-me, Dry Eye Doctor Near Me Downtown, Downtown eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Downtown, Garden Grove. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 10-15 minutes from Downtown. (949) 658-2372";
...
export default DryEyeDoctorNearMeDowntownPage;