...
const DryEyeDoctorNearMeEastsidePage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Eastside"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Eastside!",
    "author": "Robert K.",
    "location": "Eastside",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Eastside.",
    "author": "David W.",
    "location": "Eastside",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Eastside, Eastside dry-eye-doctor-near-me, Dry Eye Doctor Near Me Eastside, Eastside eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Eastside, Costa Mesa. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 8-12 minutes from Eastside. (949) 658-2372";
...
export default DryEyeDoctorNearMeEastsidePage;