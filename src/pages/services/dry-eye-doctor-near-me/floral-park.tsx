...
const DryEyeDoctorNearMeFloralParkPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Floral Park"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Floral Park!",
    "author": "Robert K.",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Floral Park.",
    "author": "David W.",
    "location": "Floral Park",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Floral Park, Floral Park dry-eye-doctor-near-me, Dry Eye Doctor Near Me Floral Park, Floral Park eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Floral Park, Santa Ana. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 5-8 minutes from Floral Park. (949) 658-2372";
...
export default DryEyeDoctorNearMeFloralParkPage;