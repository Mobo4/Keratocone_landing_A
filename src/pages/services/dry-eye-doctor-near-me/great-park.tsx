...
const DryEyeDoctorNearMeGreatParkPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Great Park"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Great Park!",
    "author": "Robert K.",
    "location": "Great Park",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Great Park.",
    "author": "David W.",
    "location": "Great Park",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Great Park, Great Park dry-eye-doctor-near-me, Dry Eye Doctor Near Me Great Park, Great Park eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Great Park, Irvine. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 12-15 minutes from Great Park. (949) 658-2372";
...
export default DryEyeDoctorNearMeGreatParkPage;