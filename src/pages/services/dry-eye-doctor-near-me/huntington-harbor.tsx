...
const DryEyeDoctorNearMeHuntingtonHarborPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Huntington Harbor"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Huntington Harbor!",
    "author": "Robert K.",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Huntington Harbor.",
    "author": "David W.",
    "location": "Huntington Harbor",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Huntington Harbor, Huntington Harbor dry-eye-doctor-near-me, Dry Eye Doctor Near Me Huntington Harbor, Huntington Harbor eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Huntington Harbor, Huntington Beach. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 25-30 minutes from Huntington Harbor. (949) 658-2372";
...
export default DryEyeDoctorNearMeHuntingtonHarborPage;