...
const DryEyeDoctorNearMeNewportCoastPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Newport Coast"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Newport Coast!",
    "author": "Robert K.",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Newport Coast.",
    "author": "David W.",
    "location": "Newport Coast",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Newport Coast, Newport Coast dry-eye-doctor-near-me, Dry Eye Doctor Near Me Newport Coast, Newport Coast eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Newport Coast, Newport Beach. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 20-25 minutes from Newport Coast. (949) 658-2372";
...
export default DryEyeDoctorNearMeNewportCoastPage;