...
const DryEyeDoctorNearMeNorthwoodPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Northwood"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Northwood!",
    "author": "Robert K.",
    "location": "Northwood",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Northwood.",
    "author": "David W.",
    "location": "Northwood",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Northwood, Northwood dry-eye-doctor-near-me, Dry Eye Doctor Near Me Northwood, Northwood eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Northwood, Irvine. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 12-15 minutes from Northwood. (949) 658-2372";
...
export default DryEyeDoctorNearMeNorthwoodPage;