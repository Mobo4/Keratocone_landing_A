...
const DryEyeDoctorNearMeOldTownTustinPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Old Town Tustin"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Old Town Tustin!",
    "author": "Robert K.",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Old Town Tustin.",
    "author": "David W.",
    "location": "Old Town Tustin",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Old Town Tustin, Old Town Tustin dry-eye-doctor-near-me, Dry Eye Doctor Near Me Old Town Tustin, Old Town Tustin eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Old Town Tustin, Tustin. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 8-12 minutes from Old Town Tustin. (949) 658-2372";
...
export default DryEyeDoctorNearMeOldTownTustinPage;