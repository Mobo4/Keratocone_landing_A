...
const DryEyeDoctorNearMeOrangeParkAcresPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Orange Park Acres"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Orange Park Acres!",
    "author": "Robert K.",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Orange Park Acres.",
    "author": "David W.",
    "location": "Orange Park Acres",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Orange Park Acres, Orange Park Acres dry-eye-doctor-near-me, Dry Eye Doctor Near Me Orange Park Acres, Orange Park Acres eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Orange Park Acres, Orange. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 15-18 minutes from Orange Park Acres. (949) 658-2372";
...
export default DryEyeDoctorNearMeOrangeParkAcresPage;