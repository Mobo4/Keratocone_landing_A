...
const DryEyeDoctorNearMeTurtleRockPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Turtle Rock"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Turtle Rock!",
    "author": "Robert K.",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Turtle Rock.",
    "author": "David W.",
    "location": "Turtle Rock",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Turtle Rock, Turtle Rock dry-eye-doctor-near-me, Dry Eye Doctor Near Me Turtle Rock, Turtle Rock eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Turtle Rock, Irvine. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 12-15 minutes from Turtle Rock. (949) 658-2372";
...
export default DryEyeDoctorNearMeTurtleRockPage;