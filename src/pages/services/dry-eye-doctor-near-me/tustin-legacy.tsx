...
const DryEyeDoctorNearMeTustinLegacyPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Tustin Legacy"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Tustin Legacy!",
    "author": "Robert K.",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Tustin Legacy.",
    "author": "David W.",
    "location": "Tustin Legacy",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Tustin Legacy, Tustin Legacy dry-eye-doctor-near-me, Dry Eye Doctor Near Me Tustin Legacy, Tustin Legacy eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Tustin Legacy, Tustin. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 8-12 minutes from Tustin Legacy. (949) 658-2372";
...
export default DryEyeDoctorNearMeTustinLegacyPage;