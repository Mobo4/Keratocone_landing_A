...
const DryEyeDoctorNearMeUniversityParkPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near University Park"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from University Park!",
    "author": "Robert K.",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from University Park.",
    "author": "David W.",
    "location": "University Park",
  ...
  const seoKeywords = "dry-eye-doctor-near-me University Park, University Park dry-eye-doctor-near-me, Dry Eye Doctor Near Me University Park, University Park eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in University Park, Irvine. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 12-15 minutes from University Park. (949) 658-2372";
...
export default DryEyeDoctorNearMeUniversityParkPage;