...
const DryEyeDoctorNearMeWoodbridgePage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional dry eye doctor near me care near Woodbridge"
  ]
};
  
  const testimonials = [
  {
    "quote": "Suffered with dry eyes for years until I found Dr. Bonakdar. His treatment plan has given me complete relief. Worth the drive from Woodbridge!",
    "author": "Robert K.",
    "location": "Woodbridge",
  ...
  {
    "quote": "I can finally wear contacts again thanks to Dr. Bonakdar's dry eye treatment. Convenient location from Woodbridge.",
    "author": "David W.",
    "location": "Woodbridge",
  ...
  const seoKeywords = "dry-eye-doctor-near-me Woodbridge, Woodbridge dry-eye-doctor-near-me, Dry Eye Doctor Near Me Woodbridge, Woodbridge eye doctor, dry-eye-doctor-near-me near me";
  const metaDescription = "Expert dry eye doctor near me in Woodbridge, Irvine. Dr. Bonakdar provides specialized dry eye doctor near me treatment. Same-week appointments. 12-15 minutes from Woodbridge. (949) 658-2372";
...
export default DryEyeDoctorNearMeWoodbridgePage;