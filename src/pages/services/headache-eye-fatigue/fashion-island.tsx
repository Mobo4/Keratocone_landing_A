...
const HeadacheandEyeFatigueFashionIslandPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional headache and eye fatigue care near Fashion Island"
  ]
};
  ...
  const seoKeywords = "headache-eye-fatigue Fashion Island, Fashion Island headache-eye-fatigue, Headache and Eye Fatigue Fashion Island, Fashion Island eye doctor, headache-eye-fatigue near me";
  const metaDescription = "Expert headache and eye fatigue in Fashion Island, Newport Beach. Dr. Bonakdar provides specialized headache and eye fatigue treatment. Same-week appointments. 20-25 minutes from Fashion Island. (949) 658-2372";
...
export default HeadacheandEyeFatigueFashionIslandPage;