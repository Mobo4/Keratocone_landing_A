...
const HeadacheandEyeFatigueWoodbridgePage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional headache and eye fatigue care near Woodbridge"
  ]
};
  ...
  const seoKeywords = "headache-eye-fatigue Woodbridge, Woodbridge headache-eye-fatigue, Headache and Eye Fatigue Woodbridge, Woodbridge eye doctor, headache-eye-fatigue near me";
  const metaDescription = "Expert headache and eye fatigue in Woodbridge, Irvine. Dr. Bonakdar provides specialized headache and eye fatigue treatment. Same-week appointments. 12-15 minutes from Woodbridge. (949) 658-2372";
...
export default HeadacheandEyeFatigueWoodbridgePage;