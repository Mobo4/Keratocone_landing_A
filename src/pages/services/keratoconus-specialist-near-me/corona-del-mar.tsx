...
const KeratoconusSpecialistNearMeCoronadelMarPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional keratoconus specialist near me care near Corona del Mar"
  ]
};
  ...
  const seoKeywords = "keratoconus-specialist-near-me Corona del Mar, Corona del Mar keratoconus-specialist-near-me, Keratoconus Specialist Near Me Corona del Mar, Corona del Mar eye doctor, keratoconus-specialist-near-me near me";
  const metaDescription = "Expert keratoconus specialist near me in Corona del Mar, Newport Beach. Dr. Bonakdar provides specialized keratoconus specialist near me treatment. Same-week appointments. 20-25 minutes from Corona del Mar. (949) 658-2372";
...
export default KeratoconusSpecialistNearMeCoronadelMarPage;