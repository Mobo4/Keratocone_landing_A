...
const KeratoconusSpecialistNearMeDowntownBreaPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional keratoconus specialist near me care near Downtown Brea"
  ]
};
  ...
  const seoKeywords = "keratoconus-specialist-near-me Downtown Brea, Downtown Brea keratoconus-specialist-near-me, Keratoconus Specialist Near Me Downtown Brea, Downtown Brea eye doctor, keratoconus-specialist-near-me near me";
  const metaDescription = "Expert keratoconus specialist near me in Downtown Brea, Brea. Dr. Bonakdar provides specialized keratoconus specialist near me treatment. Same-week appointments. 25-30 minutes from Downtown Brea. (949) 658-2372";
...
export default KeratoconusSpecialistNearMeDowntownBreaPage;