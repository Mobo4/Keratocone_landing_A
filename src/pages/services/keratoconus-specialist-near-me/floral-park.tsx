...
const KeratoconusSpecialistNearMeFloralParkPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional keratoconus specialist near me care near Floral Park"
  ]
};
  ...
  const seoKeywords = "keratoconus-specialist-near-me Floral Park, Floral Park keratoconus-specialist-near-me, Keratoconus Specialist Near Me Floral Park, Floral Park eye doctor, keratoconus-specialist-near-me near me";
  const metaDescription = "Expert keratoconus specialist near me in Floral Park, Santa Ana. Dr. Bonakdar provides specialized keratoconus specialist near me treatment. Same-week appointments. 5-8 minutes from Floral Park. (949) 658-2372";
...
export default KeratoconusSpecialistNearMeFloralParkPage;