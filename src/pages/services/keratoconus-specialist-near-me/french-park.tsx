...
const KeratoconusSpecialistNearMeFrenchParkPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional keratoconus specialist near me care near French Park"
  ]
};
  ...
  const seoKeywords = "keratoconus-specialist-near-me French Park, French Park keratoconus-specialist-near-me, Keratoconus Specialist Near Me French Park, French Park eye doctor, keratoconus-specialist-near-me near me";
  const metaDescription = "Expert keratoconus specialist near me in French Park, Santa Ana. Dr. Bonakdar provides specialized keratoconus specialist near me treatment. Same-week appointments. 5-8 minutes from French Park. (949) 658-2372";
...
export default KeratoconusSpecialistNearMeFrenchParkPage;