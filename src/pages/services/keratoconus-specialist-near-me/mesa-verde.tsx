...
const KeratoconusSpecialistNearMeMesaVerdePage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional keratoconus specialist near me care near Mesa Verde"
  ]
};
  ...
  const seoKeywords = "keratoconus-specialist-near-me Mesa Verde, Mesa Verde keratoconus-specialist-near-me, Keratoconus Specialist Near Me Mesa Verde, Mesa Verde eye doctor, keratoconus-specialist-near-me near me";
  const metaDescription = "Expert keratoconus specialist near me in Mesa Verde, Costa Mesa. Dr. Bonakdar provides specialized keratoconus specialist near me treatment. Same-week appointments. 8-12 minutes from Mesa Verde. (949) 658-2372";
...
export default KeratoconusSpecialistNearMeMesaVerdePage;