...
const KeratoconusSpecialistNearMeMileSquarePage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional keratoconus specialist near me care near Mile Square"
  ]
};
  ...
  const seoKeywords = "keratoconus-specialist-near-me Mile Square, Mile Square keratoconus-specialist-near-me, Keratoconus Specialist Near Me Mile Square, Mile Square eye doctor, keratoconus-specialist-near-me near me";
  const metaDescription = "Expert keratoconus specialist near me in Mile Square, Fountain Valley. Dr. Bonakdar provides specialized keratoconus specialist near me treatment. Same-week appointments. 15-20 minutes from Mile Square. (949) 658-2372";
...
export default KeratoconusSpecialistNearMeMileSquarePage;