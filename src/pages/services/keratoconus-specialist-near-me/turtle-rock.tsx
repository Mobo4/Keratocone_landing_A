...
const KeratoconusSpecialistNearMeTurtleRockPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional keratoconus specialist near me care near Turtle Rock"
  ]
};
  ...
  const seoKeywords = "keratoconus-specialist-near-me Turtle Rock, Turtle Rock keratoconus-specialist-near-me, Keratoconus Specialist Near Me Turtle Rock, Turtle Rock eye doctor, keratoconus-specialist-near-me near me";
  const metaDescription = "Expert keratoconus specialist near me in Turtle Rock, Irvine. Dr. Bonakdar provides specialized keratoconus specialist near me treatment. Same-week appointments. 12-15 minutes from Turtle Rock. (949) 658-2372";
...
export default KeratoconusSpecialistNearMeTurtleRockPage;