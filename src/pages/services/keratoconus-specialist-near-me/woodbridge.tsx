...
const KeratoconusSpecialistNearMeWoodbridgePage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional keratoconus specialist near me care near Woodbridge"
  ]
};
  ...
  const seoKeywords = "keratoconus-specialist-near-me Woodbridge, Woodbridge keratoconus-specialist-near-me, Keratoconus Specialist Near Me Woodbridge, Woodbridge eye doctor, keratoconus-specialist-near-me near me";
  const metaDescription = "Expert keratoconus specialist near me in Woodbridge, Irvine. Dr. Bonakdar provides specialized keratoconus specialist near me treatment. Same-week appointments. 12-15 minutes from Woodbridge. (949) 658-2372";
...
export default KeratoconusSpecialistNearMeWoodbridgePage;