...
const MyopiaControlNorthwoodPage: React.FC = () => {
  const service = {
  "name": "Myopia Control",
  "slug": "myopia-control",
  ...
  "neighborhoods": [
    ...
    "Professional myopia control care near Northwood"
  ]
};
  ...
  const seoKeywords = "myopia-control Northwood, Northwood myopia-control, Myopia Control Northwood, Northwood eye doctor, myopia-control near me";
  const metaDescription = "Expert myopia control in Northwood, Irvine. Dr. Bonakdar provides specialized myopia control treatment. Same-week appointments. 12-15 minutes from Northwood. (949) 658-2372";
...
export default MyopiaControlNorthwoodPage;