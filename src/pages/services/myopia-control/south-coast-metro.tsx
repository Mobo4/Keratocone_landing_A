...
const MyopiaControlSouthCoastMetroPage: React.FC = () => {
  const service = {
  "name": "Myopia Control",
  "slug": "myopia-control",
  ...
  "neighborhoods": [
    ...
    "Professional myopia control care near South Coast Metro"
  ]
};
  ...
  const seoKeywords = "myopia-control South Coast Metro, South Coast Metro myopia-control, Myopia Control South Coast Metro, South Coast Metro eye doctor, myopia-control near me";
  const metaDescription = "Expert myopia control in South Coast Metro, Costa Mesa. Dr. Bonakdar provides specialized myopia control treatment. Same-week appointments. 8-12 minutes from South Coast Metro. (949) 658-2372";
...
export default MyopiaControlSouthCoastMetroPage;