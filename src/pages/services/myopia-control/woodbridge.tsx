...
const MyopiaControlWoodbridgePage: React.FC = () => {
  const service = {
  "name": "Myopia Control",
  "slug": "myopia-control",
  ...
  "neighborhoods": [
    ...
    "Professional myopia control care near Woodbridge"
  ]
};
  ...
  const seoKeywords = "myopia-control Woodbridge, Woodbridge myopia-control, Myopia Control Woodbridge, Woodbridge eye doctor, myopia-control near me";
  const metaDescription = "Expert myopia control in Woodbridge, Irvine. Dr. Bonakdar provides specialized myopia control treatment. Same-week appointments. 12-15 minutes from Woodbridge. (949) 658-2372";
...
export default MyopiaControlWoodbridgePage;