...
const OrthokeratologyDowntownPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional orthokeratology care near Downtown"
  ]
};
  ...
  const seoKeywords = "orthokeratology Downtown, Downtown orthokeratology, Orthokeratology Downtown, Downtown eye doctor, orthokeratology near me";
  const metaDescription = "Expert orthokeratology in Downtown, Garden Grove. Dr. Bonakdar provides specialized orthokeratology treatment. Same-week appointments. 10-15 minutes from Downtown. (949) 658-2372";
...
export default OrthokeratologyDowntownPage;