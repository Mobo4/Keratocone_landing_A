...
const ScleralLensSpecialistNearMeDowntownBreaPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional scleral lens specialist near me care near Downtown Brea"
  ]
};
  ...
  const seoKeywords = "scleral-lens-specialist-near-me Downtown Brea, Downtown Brea scleral-lens-specialist-near-me, Scleral Lens Specialist Near Me Downtown Brea, Downtown Brea eye doctor, scleral-lens-specialist-near-me near me";
  const metaDescription = "Expert scleral lens specialist near me in Downtown Brea, Brea. Dr. Bonakdar provides specialized scleral lens specialist near me treatment. Same-week appointments. 25-30 minutes from Downtown Brea. (949) 658-2372";
...
export default ScleralLensSpecialistNearMeDowntownBreaPage;