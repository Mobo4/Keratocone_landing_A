...
const ScleralLensSpecialistNearMeDowntownFullertonPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional scleral lens specialist near me care near Downtown Fullerton"
  ]
};
  ...
  const seoKeywords = "scleral-lens-specialist-near-me Downtown Fullerton, Downtown Fullerton scleral-lens-specialist-near-me, Scleral Lens Specialist Near Me Downtown Fullerton, Downtown Fullerton eye doctor, scleral-lens-specialist-near-me near me";
  const metaDescription = "Expert scleral lens specialist near me in Downtown Fullerton, Fullerton. Dr. Bonakdar provides specialized scleral lens specialist near me treatment. Same-week appointments. 20-25 minutes from Downtown Fullerton. (949) 658-2372";
...
export default ScleralLensSpecialistNearMeDowntownFullertonPage;