...
const ScleralLensSpecialistNearMeNorthFullertonPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional scleral lens specialist near me care near North Fullerton"
  ]
};
  ...
  const seoKeywords = "scleral-lens-specialist-near-me North Fullerton, North Fullerton scleral-lens-specialist-near-me, Scleral Lens Specialist Near Me North Fullerton, North Fullerton eye doctor, scleral-lens-specialist-near-me near me";
  const metaDescription = "Expert scleral lens specialist near me in North Fullerton, Fullerton. Dr. Bonakdar provides specialized scleral lens specialist near me treatment. Same-week appointments. 20-25 minutes from North Fullerton. (949) 658-2372";
...
export default ScleralLensSpecialistNearMeNorthFullertonPage;