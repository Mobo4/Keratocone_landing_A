...
const ScleralLensSpecialistNearMeOrchardHillsPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional scleral lens specialist near me care near Orchard Hills"
  ]
};
  ...
  const seoKeywords = "scleral-lens-specialist-near-me Orchard Hills, Orchard Hills scleral-lens-specialist-near-me, Scleral Lens Specialist Near Me Orchard Hills, Orchard Hills eye doctor, scleral-lens-specialist-near-me near me";
  const metaDescription = "Expert scleral lens specialist near me in Orchard Hills, Irvine. Dr. Bonakdar provides specialized scleral lens specialist near me treatment. Same-week appointments. 12-15 minutes from Orchard Hills. (949) 658-2372";
...
export default ScleralLensSpecialistNearMeOrchardHillsPage;