...
const ScleralLensSpecialistNearMeSouthCoastMetroPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional scleral lens specialist near me care near South Coast Metro"
  ]
};
  ...
  const seoKeywords = "scleral-lens-specialist-near-me South Coast Metro, South Coast Metro scleral-lens-specialist-near-me, Scleral Lens Specialist Near Me South Coast Metro, South Coast Metro eye doctor, scleral-lens-specialist-near-me near me";
  const metaDescription = "Expert scleral lens specialist near me in South Coast Metro, Costa Mesa. Dr. Bonakdar provides specialized scleral lens specialist near me treatment. Same-week appointments. 8-12 minutes from South Coast Metro. (949) 658-2372";
...
export default ScleralLensSpecialistNearMeSouthCoastMetroPage;