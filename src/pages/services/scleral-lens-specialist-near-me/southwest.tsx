...
const ScleralLensSpecialistNearMeSouthwestPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional scleral lens specialist near me care near Southwest"
  ]
};
  ...
  const seoKeywords = "scleral-lens-specialist-near-me Southwest, Southwest scleral-lens-specialist-near-me, Scleral Lens Specialist Near Me Southwest, Southwest eye doctor, scleral-lens-specialist-near-me near me";
  const metaDescription = "Expert scleral lens specialist near me in Southwest, Fountain Valley. Dr. Bonakdar provides specialized scleral lens specialist near me treatment. Same-week appointments. 15-20 minutes from Southwest. (949) 658-2372";
...
export default ScleralLensSpecialistNearMeSouthwestPage;