...
const ScleralLensSpecialistNearMeTurtleRockPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional scleral lens specialist near me care near Turtle Rock"
  ]
};
  ...
  const seoKeywords = "scleral-lens-specialist-near-me Turtle Rock, Turtle Rock scleral-lens-specialist-near-me, Scleral Lens Specialist Near Me Turtle Rock, Turtle Rock eye doctor, scleral-lens-specialist-near-me near me";
  const metaDescription = "Expert scleral lens specialist near me in Turtle Rock, Irvine. Dr. Bonakdar provides specialized scleral lens specialist near me treatment. Same-week appointments. 12-15 minutes from Turtle Rock. (949) 658-2372";
...
export default ScleralLensSpecialistNearMeTurtleRockPage;