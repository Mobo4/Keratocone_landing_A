...
const ScleralLensSpecialistNearMeUniversityParkPage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional scleral lens specialist near me care near University Park"
  ]
};
  ...
  const seoKeywords = "scleral-lens-specialist-near-me University Park, University Park scleral-lens-specialist-near-me, Scleral Lens Specialist Near Me University Park, University Park eye doctor, scleral-lens-specialist-near-me near me";
  const metaDescription = "Expert scleral lens specialist near me in University Park, Irvine. Dr. Bonakdar provides specialized scleral lens specialist near me treatment. Same-week appointments. 12-15 minutes from University Park. (949) 658-2372";
...
export default ScleralLensSpecialistNearMeUniversityParkPage;