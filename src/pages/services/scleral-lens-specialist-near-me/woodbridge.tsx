...
const ScleralLensSpecialistNearMeWoodbridgePage: React.FC = () => {
  const service = {
  ...
  "neighborhoods": [
    ...
    "Professional scleral lens specialist near me care near Woodbridge"
  ]
};
  ...
  const seoKeywords = "scleral-lens-specialist-near-me Woodbridge, Woodbridge scleral-lens-specialist-near-me, Scleral Lens Specialist Near Me Woodbridge, Woodbridge eye doctor, scleral-lens-specialist-near-me near me";
  const metaDescription = "Expert scleral lens specialist near me in Woodbridge, Irvine. Dr. Bonakdar provides specialized scleral lens specialist near me treatment. Same-week appointments. 12-15 minutes from Woodbridge. (949) 658-2372";
...
export default ScleralLensSpecialistNearMeWoodbridgePage;